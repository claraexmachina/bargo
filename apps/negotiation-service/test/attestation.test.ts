...
const EXPECTED_CANONICAL =
  '{"gpu_evidence":"0xcafebabe","quote":"0xdeadbeef","signature":"0x' +
  'ff'.repeat(32) +
  '","signed_response":{"completion_id":"chatcmpl-fixture-001","model":"qwen3-30b","nonce":"0x' +
  'aa'.repeat(32) +
  '","timestamp":1713312345},"signing_key":"0x04' +
  'ab'.repeat(32) +
  '"}';
